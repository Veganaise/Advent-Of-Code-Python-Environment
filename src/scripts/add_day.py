...
from scripts.get_inputs import get_input
from util.console import console
from util.input_helpers import get_input_for_day
...
def add_day():
    ...
    # Solution file
    module_path = os.path.join(AOC_DIR, f'year_{year}')
    ...
    # Test file
    test_module_path = os.path.abspath(os.path.join(AOC_DIR, 'tests', f'year_{year}'))
    ...
    # Empty test input
    test_input_module_path = os.path.abspath(os.path.join(test_module_path, f'inputs'))
...
def verify_input_exists(year: int, day: int) -> None:
    try:
        ...
        try:
            ...
            console.print(f'[red]Could not retrieve input data for year {year} day {day}')
            return
